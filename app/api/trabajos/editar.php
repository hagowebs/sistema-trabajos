<?php // app/api/trabajos/editar.php
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    try {
        ...
        $required_fields = ['id_cliente','id_encargado','categoria','trabajo', 'fecha_inicial','fecha_final',
        ...
        $check_sql = "SELECT id FROM trabajos WHERE id = :id";
        ...
        $sql = "UPDATE trabajos 
                SET id_cliente = :id_cliente, id_encargado = :id_encargado, categoria = :categoria, trabajo = :trabajo,
                fecha_inicial = :fecha_inicial, fecha_final = :fecha_final, envio = :envio, estado = :estado,
                precio = :precio, anticipo = :anticipo, restante = :restante, metodo_pago = :metodo_pago,
                anticipo2 = :anticipo2, restante2 = :restante2, metodo_pago2 = :metodo_pago2, fecha2 = :fecha2,
                anticipo3 = :anticipo3, restante3 = :restante3, metodo_pago3 = :metodo_pago3, fecha3 = :fecha3
                WHERE id = :id";
