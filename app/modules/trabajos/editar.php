<?php // app/modules/trabajos/editar.php
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    try {
        ...
        $sql = "UPDATE trabajos 
                SET id_cliente = :id_cliente, id_vendedor = :id_vendedor, id_encargado = :id_encargado, categoria = :categoria,
                trabajo = :trabajo, fecha_inicial = :fecha_inicial, fecha_final = :fecha_final, envio = :envio, estado = :estado,
