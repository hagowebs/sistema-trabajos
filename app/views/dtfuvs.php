    ...
    <main class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Registro de Dtfuvs</h1>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalDtfuv">
                                        <i class="fas fa-plus"></i> Nuevo Dtfuv
                                    </button>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <table id="tablaDtfuv" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Cliente</th>
    ...
    <div class="modal fade" id="modalDtfuv" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">

                <div class="modal-header">
                    <h4 class="modal-title" id="tituloModal">Nuevo Dtfuv</h4>
                ...
                <form id="formDtfuv">
                    <div class="modal-body">
                        <input type="hidden" id="dtfuvId" name="id">
                        <div class="form-group">
                            <label for="dtfuv">Cliente *</label>
                            <input type="text" class="form-control" id="dtfuv" name="dtfuv" required>
                        </div>
                        <div class="form-group">
