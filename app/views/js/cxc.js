$(document).ready(function() {
    ...
    var tabla = $('#tablaTrabajo').DataTable({
        "ajax": {
            "url": "app/api/cxc/listar.php",
            "type": "POST",
            "data": function(d) {

                // Revisar si hay algun filtro activo
                var isAnyFilterActive = $('#daterange').val() !== '' || $('#estado_filter').val() !== '' || $('#cliente_filter').val() !== '';
    ...
    // Obtener lista de clientes en filtro
    $('#cliente_filter').select2({
    ...
    $('#btn_limpiar').click(function() {
        $('#daterange').val('');
        $('#estado_filter').val('');
        $('#cliente_filter').val(null).trigger('change');
        tabla.ajax.reload();
    });
    ...
    $('#cliente_filter').change(function() {
        tabla.ajax.reload();
    });
