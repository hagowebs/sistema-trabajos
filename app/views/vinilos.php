    ...
    <main class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Registro de Viniles</h1>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalVinilo">
                                        <i class="fas fa-plus"></i> Nuevo Vinil
                                    </button>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <table id="tablaVinilo" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Cliente</th>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title" id="tituloModal">Nuevo Vinil</h4>
                ...
                <form id="formVinilo">
                    <div class="modal-body">
                        <input type="hidden" id="viniloId" name="id">
                        <div class="form-group">
                            <label for="vinilo">Cliente *</label>
                            <input type="text" class="form-control" id="vinilo" name="vinilo" required>
                        </div>
                        <div class="form-group">
